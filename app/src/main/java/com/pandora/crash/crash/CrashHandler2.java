package com.pandora.crash.crash;
...
import com.pandora.crash.MyApp;
...
public class CrashHandler2 implements UncaughtExceptionHandler {
    private static final String TAG = CrashHandler2.class.getSimpleName();

    private static CrashHandler2 instance = null;
    ...
    private CrashHandler2(Context context) {
        mContext = context;
        mDefaultHandler = Thread.getDefaultUncaughtExceptionHandler();
        Thread.setDefaultUncaughtExceptionHandler(this);
    }

    public static CrashHandler2 getInstance(Context context) {
        if (instance == null) {
            synchronized (CrashHandler2.class) {
                if (instance == null) {
                    instance = new CrashHandler2(context);
                }
            }
        }
        return instance;
    ...
    private void saveCrashInfo2File(Throwable ex) {
        ...
        try {
            ...
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())) {
                ...
                String path = "/sdcard/" + packageName + "/crash_log/";
